...
public class PublicationsDummy implements DummyData {
	...
	private void initializeContext() {
		...
		publication.addBookingRequest(createStartedBooking(new UsersDummy().getUsers().get(0),20,new DateTime(2018,2,15,5,28)));
		...
		publication.addBookingRequest(createStartedBooking(new UsersDummy().getUsers().get(0),20,new DateTime(2018,2,15,10,41)));
